...
- This project supports Ubuntu 20.04/22.04/24.04 on target devices.
- Download a preinstalled Ubuntu Server image for Raspberry Pi from [the official website](https://ubuntu.com/download/raspberry-pi), and flash it into your SD card.
